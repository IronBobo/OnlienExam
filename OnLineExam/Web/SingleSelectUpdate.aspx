<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SingleSelectUpdate.aspx.cs" Inherits="Web_SingleSelectUpdate" Title="Untitled Page" %>
            ...
            <table cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc" style="border-collapse: collapse"
                ...
                <tr>
                    ...
                    <td style="height: 25px">
                        &nbsp;<div align="left">
                            <asp:DropDownList ID="ddlCourse" runat="server" Font-Size="9pt" Width="88px" DataTextField="Name"
                                DataValueField="ID">
                            </asp:DropDownList>
                        </div>
                    </td>
                ...
                <tr>
                    <td bgcolor="#eeeeee" style="text-align: right; height: 22px;">
                        答案C：
                    </td>
