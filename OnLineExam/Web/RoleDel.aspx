<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="RoleDel.aspx.cs" Inherits="Web_RoleDel" Title="Untitled Page" %>
        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc" style="border-collapse: collapse"
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;<div align="left">
                            <asp:TextBox ID="txtRoleID" runat="server" MaxLength="20"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtRoleID"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:ImageButton ID="imgBtnSave" runat="server" ImageUrl="~/Images/Delete.GIF" OnClick="imgBtnSave_Click" />
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        <asp:ImageButton ID="imgBtnReturn" runat="server" CausesValidation="false" ImageUrl="../Images/Return.GIF"
                            PostBackUrl="~/Web/Role.aspx" />
                    </td>
                </tr>
            </table>
        </ContentTemplate>
